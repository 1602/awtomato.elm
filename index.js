...
/******/ 	__webpack_require__.p = "https://localhost:3000/";
...
/***/ (function(module, exports) {
	...
	var _user$project$Fragments_SelectorTooltip$coloredText = F2(
		function (color, str) {
			return A2(
	...
	var _user$project$Fragments_SelectorTooltip$coloredNodes = F2(
	...
	var _user$project$Fragments_SelectorTooltip$tooltipTriangle = function (isAboveElement) {
		return isAboveElement ? A2(
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'border', _1: '7px solid transparent'},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'border-top-color', _1: '#333740'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'border-bottom-color', _1: 'transparent'},
													_1: {ctor: '[]'}
												}
											}
										}
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'top', _1: '-14px'},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'border-bottom-color', _1: '#333740'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'border-top-color', _1: 'transparent'},
													_1: {ctor: '[]'}
												}
											}
										}
	...
	var _user$project$Fragments_SelectorTooltip$selectorTooltipInlineStyle = F2(
		function (isAboveElement, height) {
			var top = isAboveElement ? '-28px' : A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(height + 10),
				'px');
			return {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'padding-right', _1: '6px'},
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'font-weight', _1: 'normal'},
															_1: {
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: 'font-family', _1: 'menlo, monospace'},
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'font-size', _1: '10px'},
																	_1: {
																		ctor: '::',
																		_0: {ctor: '_Tuple2', _0: 'background', _1: '#333740'},
																		_1: {
																			ctor: '::',
																			_0: {ctor: '_Tuple2', _0: 'color', _1: '#D9D9D9'},
																			_1: {
																				ctor: '::',
	...
	var _user$project$Fragments_SelectorTooltip$selectorTooltip = F2(
		function (el, screenHeight) {
			var classes = A2(
				_elm_lang$core$List$map,
				_user$project$Fragments_SelectorTooltip$coloredText('#8ED3FB'),
				A2(
					_elm_lang$core$List$map,
					F2(
						function (x, y) {
			...
			var tag = A2(
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'color', _1: '#EE78E6'},
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(el.tagName),
					_1: {ctor: '[]'}
				});
			var id = function () {
				var _p0 = el.id;
				if (_p0.ctor === 'Just') {
					return A2(
						_user$project$Fragments_SelectorTooltip$coloredText,
						'#FFAB66',
			...
			var dimensions = A2(
				...
				{ctor: '[]'});
			var heightOfTooltip = 35;
			var bottomOfTheScreen = (screenHeight - heightOfTooltip) - el.distanceToTop;
			var topCoordinate = A2(_elm_lang$core$Basics$min, bottomOfTheScreen, el.height);
			var isAboveElement = _elm_lang$core$Native_Utils.cmp(el.distanceToTop, heightOfTooltip) > 0;
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
						A2(_user$project$Fragments_SelectorTooltip$selectorTooltipInlineStyle, isAboveElement, topCoordinate)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _user$project$Fragments_SelectorTooltip$tooltipTriangle(isAboveElement),
					_1: {
						ctor: '::',
						_0: tag,
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_user$project$Fragments_SelectorTooltip$coloredNodes, '#8ED3FB', classes),
								_1: {
									ctor: '::',
									_0: A2(_user$project$Fragments_SelectorTooltip$coloredText, '#7F7F7F', ' | '),
									_1: {
										ctor: '::',
										_0: dimensions,
										_1: {ctor: '[]'}
	...
	var _user$project$Main$elementUnderCursorStyle = {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'background', _1: 'rgba(130, 240, 90, 0.1)'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'box-shadow', _1: '0 0 0 5px rgba(30, 40, 190, 0.1)'},
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'cursor', _1: '-webkit-grab'},
						_1: {ctor: '[]'}
					}
				}
			}
	...
	var _user$project$Main$rejectedElementStyle = {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'background', _1: 'none'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'box-shadow', _1: '0 0 0 2px rgba(130, 30, 30, 0.1618)'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'border-radius', _1: '0px'},
				_1: {
	...
	var _user$project$Main$primaryPickStyle = {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'background', _1: 'rgba(30, 30, 230, 0.1)'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'box-shadow', _1: '0 0 0 5px rgba(30, 30, 230, 0.1618)'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'border-radius', _1: '0px'},
				_1: {
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'cursor', _1: '-webkit-grabbing'},
						_1: {ctor: '[]'}
					}
				}
			}
	...
	var _user$project$Main$pickedElementStyle = {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'background', _1: 'rgba(30, 130, 30, 0.1)'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'box-shadow', _1: '0 0 0 2px rgba(30, 130, 30, 0.1618)'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'border-radius', _1: '0px'},
				_1: {
	...
	var _user$project$Main$renderBox = F4(
		function (el, nodes, click, inlineStyle) {
			var px = function (n) {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(n),
					...
					_0: _elm_lang$html$Html_Attributes$style(
						A2(
							_elm_lang$core$Basics_ops['++'],
							{
								...
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'z-index', _1: '100000'},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
	...
	var _user$project$Main$toggle = F2(
		function (dict, element) {
			return A2(_elm_lang$core$Dict$member, element.elementId, dict) ? A2(_elm_lang$core$Dict$remove, element.elementId, dict) : A3(_elm_lang$core$Dict$insert, element.elementId, element, dict);
		});
	var _user$project$Main$boundingRectAtPosition = _elm_lang$core$Native_Platform.outgoingPort(
		'boundingRectAtPosition',
		function (v) {
			return {x: v.x, y: v.y};
		});
	var _user$project$Main$activeElement = _elm_lang$core$Native_Platform.incomingPort(
		'activeElement',
								...
								return A2(
									...
									function (y) {
										return A2(
																						...
																						return A2(
																							...
																							function (elementId) {
																								return _elm_lang$core$Json_Decode$succeed(
																									{x: x, y: y, distanceToTop: distanceToTop, width: width, height: height, id: id, tagName: tagName, classList: classList, elementId: elementId});
																							},
																							A2(_elm_lang$core$Json_Decode$field, 'elementId', _elm_lang$core$Json_Decode$int));
																					},
																					A2(
											...
											A2(_elm_lang$core$Json_Decode$field, 'distanceToTop', _elm_lang$core$Json_Decode$int));
									},
	...
	var _user$project$Main$pickElement = _elm_lang$core$Native_Platform.outgoingPort(
		'pickElement',
		function (v) {
			return {
				elementId: v.elementId,
				rejects: _elm_lang$core$Native_List.toArray(v.rejects).map(
					function (v) {
						return v;
					})
			};
		});
	var _user$project$Main$pickedElements = _elm_lang$core$Native_Platform.incomingPort(
		'pickedElements',
		A2(
			_elm_lang$core$Json_Decode$andThen,
			function (selector) {
				return A2(
					...
					function (elements) {
						return _elm_lang$core$Json_Decode$succeed(
							{selector: selector, elements: elements});
					},
					A2(
						_elm_lang$core$Json_Decode$field,
						'elements',
			...
			A2(_elm_lang$core$Json_Decode$field, 'selector', _elm_lang$core$Json_Decode$string)));
	var _user$project$Main$getMousePosition = _elm_lang$core$Native_Platform.outgoingPort(
		'getMousePosition',
		function (v) {
			return v;
		});
	var _user$project$Main$mousePosition = _elm_lang$core$Native_Platform.incomingPort(
		'mousePosition',
		A2(
			_elm_lang$core$Json_Decode$andThen,
			function (x) {
	...
	var _user$project$Main$Model = F5(
		function (a, b, c, d, e) {
			return {mouse: a, windowSize: b, elementUnderCursor: c, lookupActive: d, entity: e};
		});
	var _user$project$Main$Entity = F4(
		function (a, b, c, d) {
			return {primaryPick: a, pickedElements: b, rejects: c, selector: d};
		});
	var _user$project$Main$Element = F9(
		function (a, b, c, d, e, f, g, h, i) {
			return {x: a, y: b, distanceToTop: c, width: d, height: e, id: f, tagName: g, classList: h, elementId: i};
		});
	var _user$project$Main$PickingResult = F2(
		function (a, b) {
			return {selector: a, elements: b};
		});
	var _user$project$Main$VisibilityChange = function (a) {
		return {ctor: 'VisibilityChange', _0: a};
	};
	var _user$project$Main$Reset = {ctor: 'Reset'};
	var _user$project$Main$QueryPage = {ctor: 'QueryPage'};
			...
			while (true) {
				...
				var lookup = function (state) {
					return _elm_lang$core$Native_Utils.update(
						model,
						{lookupActive: state, elementUnderCursor: _elm_lang$core$Maybe$Nothing});
				};
				var lookupActivationKey = 18;
				var _p1 = msg;
				switch (_p1.ctor) {
					case 'NoOp':
						return A2(
					...
					case 'MouseMove':
						...
						return A2(
							...
							{
								ctor: '::',
								_0: _user$project$Main$boundingRectAtPosition(_p2),
								_1: {ctor: '[]'}
							});
					case 'ActiveElement':
						return A2(
					...
					case 'Reset':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									entity: _elm_lang$core$Native_Utils.update(
										entity,
										{
											primaryPick: 0,
											rejects: _elm_lang$core$Dict$empty,
											pickedElements: {ctor: '[]'},
											selector: ''
										})
								}),
							{ctor: '[]'});
					case 'PickElement':
						var _p3 = model.elementUnderCursor;
						if (_p3.ctor === 'Nothing') {
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								model,
							...
							var _v2 = _user$project$Main$QueryPage,
								_v3 = _elm_lang$core$Native_Utils.update(
								model,
								{
									elementUnderCursor: _elm_lang$core$Maybe$Nothing,
									entity: _elm_lang$core$Native_Utils.update(
										entity,
										{primaryPick: _p3._0.elementId, rejects: _elm_lang$core$Dict$empty})
								});
							msg = _v2;
							model = _v3;
							continue update;
					...
					case 'QueryPage':
						return A2(
							...
							{
								ctor: '::',
								_0: _user$project$Main$pickElement(
									{
										elementId: entity.primaryPick,
										rejects: _elm_lang$core$Dict$keys(entity.rejects)
									}),
								_1: {ctor: '[]'}
							});
					case 'ToggleReject':
						var _v4 = _user$project$Main$QueryPage,
							...
							model,
							{
								entity: _elm_lang$core$Native_Utils.update(
									entity,
									{
										rejects: A2(_user$project$Main$toggle, entity.rejects, _p1._0)
									})
							});
						msg = _v4;
						model = _v5;
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									entity: _elm_lang$core$Native_Utils.update(
										entity,
										{pickedElements: _p1._0.elements, selector: _p1._0.selector})
								}),
							{ctor: '[]'});
					case 'WindowResize':
						return A2(
							...
							{ctor: '[]'});
					case 'KeyDown':
						return _elm_lang$core$Native_Utils.eq(_p1._0, lookupActivationKey) ? A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							lookup(true),
							{
								ctor: '::',
								_0: _user$project$Main$getMousePosition(1),
								_1: {ctor: '[]'}
							}) : A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
					...
					default:
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									lookupActive: A2(_elm_lang$core$Debug$log, 'change visi', false)
								}),
							{ctor: '[]'});
				}
			}
		});
	var _user$project$Main$ToggleReject = function (a) {
		return {ctor: 'ToggleReject', _0: a};
	};
	var _user$project$Main$PickedElements = function (a) {
		return {ctor: 'PickedElements', _0: a};
	};
	var _user$project$Main$PickElement = {ctor: 'PickElement'};
	var _user$project$Main$view = function (model) {
		var entity = model.entity;
		var active = function () {
			var _p4 = model.elementUnderCursor;
			if (_p4.ctor === 'Just') {
				var _p5 = _p4._0;
				return (!_elm_lang$core$Native_Utils.eq(_p5.elementId, entity.primaryPick)) ? A4(
					_user$project$Main$renderBox,
					_p5,
					{
						ctor: '::',
						_0: A2(_user$project$Fragments_SelectorTooltip$selectorTooltip, _p5, model.windowSize.height),
						_1: {ctor: '[]'}
					},
					_user$project$Main$PickElement,
					_user$project$Main$elementUnderCursorStyle) : _elm_lang$html$Html$text('');
			} else {
				return _elm_lang$html$Html$text('');
			}
		}();
		var picked = A2(
			...
			function (el) {
				return A4(
					...
					el,
					{ctor: '[]'},
					_elm_lang$core$Native_Utils.eq(el.elementId, entity.primaryPick) ? _user$project$Main$Reset : _user$project$Main$ToggleReject(el),
					_elm_lang$core$Native_Utils.eq(el.elementId, entity.primaryPick) ? _user$project$Main$primaryPickStyle : _user$project$Main$pickedElementStyle);
			},
		...
		var rejected = A2(
			...
			function (el) {
				return A4(
					...
					el,
					{ctor: '[]'},
					_user$project$Main$ToggleReject(el),
					_user$project$Main$rejectedElementStyle);
			},
			_elm_lang$core$Dict$values(entity.rejects));
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
													...
													_1: {
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'font-family', _1: 'menlo, monospaced'},
																	_1: {
																		ctor: '::',
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(entity.selector),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$div,
												...
												_0: _elm_lang$html$Html$text(
													A2(
														...
														_elm_lang$core$Basics$toString(
															_elm_lang$core$List$length(entity.pickedElements)),
														' elem.')),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
	...
	var _user$project$Main$init = A2(
		...
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Task$perform, _user$project$Main$WindowResize, _elm_lang$window$Window$size),
			_1: {ctor: '[]'}
		});
	...
	var _user$project$Main$ActiveElement = function (a) {
		return {ctor: 'ActiveElement', _0: a};
	};
	...
	var _user$project$Main$subscriptions = function (model) {
		return _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: model.lookupActive ? _elm_lang$mouse$Mouse$moves(_user$project$Main$MouseMove) : _elm_lang$core$Platform_Sub$none,
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _user$project$Main$activeElement(_user$project$Main$ActiveElement),
								_1: {
									ctor: '::',
									_0: _user$project$Main$pickedElements(_user$project$Main$PickedElements),
									_1: {
										ctor: '::',
										_0: _user$project$Main$mousePosition(_user$project$Main$MouseMove),
										_1: {
											ctor: '::',
											_0: _elm_lang$page_visibility$PageVisibility$visibilityChanges(_user$project$Main$VisibilityChange),
											_1: {ctor: '[]'}
										}
									}
								}
